...
===Known Issues===
The robe will clip with certain clothes/armor if worn together; this is unavoidable based on the outfit style. 
There is no 1st person model for the robes yet.

===Permissions===
Feel free to use this model in your own mod projects freely.

===Credits===
Credit to Bethesda for the original lich model
Blender Foundation
Nifskope
