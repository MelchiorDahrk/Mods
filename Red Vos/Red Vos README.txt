...
v2.0 - Added dependency on Static Switching System (OpenMW). Removed old Windoors Glow compatibility patch. Glow in the Dahrk compatibility is now integrated (no separate patch required). Added HD texture option. Added fomod.